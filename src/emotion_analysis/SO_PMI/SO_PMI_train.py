...
class SoPmi:
    def __init__(self):
        self.train_path = 'res\\dicts\\sopmi\\train_all.txt'
        self.candipos_path = 'res\\dicts\\sopmi\\pos.txt'
        self.candineg_path = 'res\\dicts\\sopmi\\neg.txt'
        self.sentiment_path = 'res\\dicts\\sopmi\\sentiment-words.txt'
...
if __name__ == "__main__":
    sopmier = SoPmi()
    sopmier.sopmi()
    # file = open('res\\input\\SOPMI\\/pos.txt', encoding='utf-8')
    # file2 = open('res\\input\\dict\\extra.txt', 'w+', encoding='utf-8')
    # df = file.read().split()
    # data = []
    # i = 0
    # while i < 2000:
